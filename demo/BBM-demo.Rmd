...
`data/outputs/priors_plots/<parcellation>/<encoding>/FC/`
...
The figures below show the mean and standard deviation of FC priors using Cholesky and Inverse-Wishart methods.Only combined priors are shown.
